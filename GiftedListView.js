...
var GiftedListView = React.createClass({
    ...
    propTypes: {
        ...
        endReachedThreshold: React.PropTypes.number, //达到底部的距离值
    ...
    renderListView(style = {}) {
        return (
            <ListView
                ...
                onScroll={this.props.refreshable === true && Platform.OS !== 'android' ? this._onScroll : this._onScroll}
                ...
                onEndReached={(e)=> { if(e!=undefined){ this._onPaginate(); } }}
